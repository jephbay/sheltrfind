package shelterfind.android.example.com.shelterfind.shelterfind.model
...
public class CloudData{
 ...
 var ratings:Int?=null
    ...
    constructor(roomtype: Any?, roomtypeprice: Any?, roomavailability: String?, overview: Any?,
                ...
                address: Any?, statuscomplete: Boolean?,type:String?,userID:String?,progress:String?,comment:Any?=null,ratings:Int?=null) {
