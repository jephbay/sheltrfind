...
class HomeFilterAdaptor(data: ArrayList<CloudData>, listener: OnItemClickListener):
        RecyclerView.Adapter<HomeFilterAdaptor.RecyclerViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerViewHolder {
        ...
        return RecyclerViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.item_card_view, parent, false))
