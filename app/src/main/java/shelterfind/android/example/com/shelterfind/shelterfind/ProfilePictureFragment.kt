...
class ProfilePictureFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val getdata= facilities[destin!!]



        val mtype = prefs.getString("mtype","none")
         ...
         mFirebaseFirestore
                 ...
                 .document(mtype!!).addSnapshotListener { documentSnapshot, firebaseFirestoreException ->
                     ...
                     if (firebaseFirestoreException!=null){
                         ...
                         if ( documentSnapshot!!.getString("captionurl")!=null){

                             val capurl=    documentSnapshot.getString("captionurl") as String
                             Picasso.get().load( Uri.parse(capurl)).fit().into(profile_pic)
                         }
                                ...
                                myCollectionReference.get().addOnCompleteListener {task ->
                                    if (task.isSuccessful){
                                        ...
                                        with(activity?.getPreferences(Context.MODE_PRIVATE)!!.edit()) {
                                            putString("mtype",task.result.last().id)
                                            apply()
                                        }
